...
all_file_names = os.listdir('Data_Study1/')
        ...
        for orientation in orientation_condition:
            for file_name in all_file_names:
                if touch in file_name and elbow in file_name and orientation in file_name:
                    ...
                    temp_data_pd = pandas.read_csv("Data_Study1/"+file_name)
                    ...
                    data_pandas.to_csv('Data_Study1_Difference/'+file_name, index= False)
